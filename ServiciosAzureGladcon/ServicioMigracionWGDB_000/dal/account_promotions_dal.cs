                    ...
                    using (var dr = command.ExecuteReader())
                    {
                        if (dr.HasRows)
                        {
                            while (dr.Read())
                            {
                                ...
                                {
                                    acp_unique_id = ManejoNulos.ManageNullInteger64(dr["acp_unique_id"]),
                                    acp_created = ManejoNulos.ManageNullDate(dr["acp_created"]),
                                    acp_account_id = ManejoNulos.ManageNullInteger64(dr["acp_account_id"]),
                                    acp_account_level = ManejoNulos.ManageNullInteger(dr["acp_account_level"]),
                                    acp_promo_type = ManejoNulos.ManageNullInteger(dr["acp_promo_type"]),
                                    acp_promo_id = ManejoNulos.ManageNullInteger64(dr["acp_promo_id"]),
                                    acp_promo_name = ManejoNulos.ManageNullStr(dr["acp_promo_name"]),
                                    acp_promo_date = ManejoNulos.ManageNullDate(dr["acp_promo_date"]),
                                    acp_operation_id = ManejoNulos.ManageNullInteger64(dr["acp_operation_id"]),
                                    acp_credit_type = ManejoNulos.ManageNullInteger(dr["acp_credit_type"]),
                                    acp_activation = ManejoNulos.ManageNullDate(dr["acp_activation"]),
                                    acp_expiration = ManejoNulos.ManageNullDate(dr["acp_expiration"]),
                                    acp_cash_in = ManejoNulos.ManageNullDecimal(dr["acp_cash_in"]),
                                    acp_points = ManejoNulos.ManageNullDecimal(dr["acp_points"]),
                                    acp_ini_balance = ManejoNulos.ManageNullDecimal(dr["acp_ini_balance"]),
                                    acp_ini_withhold = ManejoNulos.ManageNullDecimal(dr["acp_ini_withhold"]),
                                    acp_ini_wonlock = ManejoNulos.ManageNullDecimal(dr["acp_ini_wonlock"]),
                                    acp_balance = ManejoNulos.ManageNullDecimal(dr["acp_balance"]),
                                    acp_withhold = ManejoNulos.ManageNullDecimal(dr["acp_withhold"]),
                                    acp_wonlock = ManejoNulos.ManageNullDecimal(dr["acp_wonlock"]),
                                    acp_played = ManejoNulos.ManageNullDecimal(dr["acp_played"]),
                                    acp_won = ManejoNulos.ManageNullDecimal(dr["acp_won"]),
                                    acp_status = ManejoNulos.ManageNullInteger(dr["acp_status"]),
                                    acp_updated = ManejoNulos.ManageNullDate(dr["acp_updated"]),
                                    acp_play_session_id = ManejoNulos.ManageNullInteger64(dr["acp_play_session_id"]),
                                    acp_transaction_id = ManejoNulos.ManageNullInteger64(dr["acp_transaction_id"]),
                                    acp_recommended_account_id = ManejoNulos.ManageNullInteger64(dr["acp_recommended_account_id"]),
                                    acp_details = ManejoNulos.ManageNullStr(dr["acp_details"]),
                                    acp_promo_category_id = ManejoNulos.ManageNullInteger(dr["acp_promo_category_id"]),
                                    acp_redeemable_cost = ManejoNulos.ManageNullDecimal(dr["acp_redeemable_cost"]),
                                    acp_prize_type = ManejoNulos.ManageNullInteger(dr["acp_prize_type"]),
                                    acp_prize_gross = ManejoNulos.ManageNullDecimal(dr["acp_prize_gross"]),
                                    acp_prize_tax1 = ManejoNulos.ManageNullDecimal(dr["acp_prize_tax1"]),
                                    acp_prize_tax2 = ManejoNulos.ManageNullDecimal(dr["acp_prize_tax2"]),
                                    acp_prize_tax3 = ManejoNulos.ManageNullDecimal(dr["acp_prize_tax3"]),
                                    acp_pyramid_prize = ManejoNulos.ManageNullDecimal(dr["acp_pyramid_prize"]),
                                    acp_draw_price = ManejoNulos.ManageNullDecimal(dr["acp_draw_price"]),
                                    acp_total_prize = ManejoNulos.ManageNullDecimal(dr["acp_total_prize"]),
                                    acp_prize_tax4 = ManejoNulos.ManageNullDecimal(dr["acp_prize_tax4"]),
                                    acp_prize_tax5 = ManejoNulos.ManageNullDecimal(dr["acp_prize_tax5"]),
                                    acp_promogame_return_price_pct = ManejoNulos.ManageNullDecimal(dr["acp_promogame_return_price_pct"]),
                                    acp_ms_id = ManejoNulos.ManageNullInteger64(dr["acp_ms_id"]),
                                    acp_ms_sequence_id = ManejoNulos.ManageNullInteger64(dr["acp_ms_sequence_id"]),
                                    acp_site_redeemed = ManejoNulos.ManageNullInteger(dr["acp_site_redeemed"]),
                                    acp_import_filename = ManejoNulos.ManageNullStr(dr["acp_import_filename"]),
                                    acp_ms_promo_id = ManejoNulos.ManageNullInteger64(dr["acp_ms_promo_id"]),
                                    acp_lock_enabled = ManejoNulos.ManageNullInteger(dr["acp_lock_enabled"]),
                                    acp_lock_balance_factor = ManejoNulos.ManageNullInteger(dr["acp_lock_balance_factor"]),
                                    acp_lock_balance_amount = ManejoNulos.ManageNullDecimal(dr["acp_lock_balance_amount"]),
                                    acp_lock_coin_in_factor = ManejoNulos.ManageNullInteger(dr["acp_lock_coin_in_factor"]),
                                    acp_lock_coin_in_amount = ManejoNulos.ManageNullDecimal(dr["acp_lock_coin_in_amount"]),
                                    acp_lock_average_bet = ManejoNulos.ManageNullDecimal(dr["acp_lock_average_bet"]),
                                    acp_lock_plays = ManejoNulos.ManageNullInteger(dr["acp_lock_plays"]),
                                    acp_lock_max_payable_factor_enabled = ManejoNulos.ManageNullInteger(dr["acp_lock_max_payable_factor_enabled"]),
                                    acp_lock_max_payable_factor = ManejoNulos.ManageNullDecimal(dr["acp_lock_max_payable_factor"]),
                                    acp_lock_max_payable_amount_enabled = ManejoNulos.ManageNullInteger(dr["acp_lock_max_payable_amount_enabled"]),
                                    acp_lock_max_payable_amount = ManejoNulos.ManageNullDecimal(dr["acp_lock_max_payable_amount"]),
                                    acp_lock_min_payable_amount = ManejoNulos.ManageNullDecimal(dr["acp_lock_min_payable_amount"]),
                                    acp_cash_in_max_reward = ManejoNulos.ManageNullDecimal(dr["acp_cash_in_max_reward"]),
                                    acp_weights_id = ManejoNulos.ManageNullInteger(dr["acp_weights_id"]),
                                    acp_total_played_weighted = ManejoNulos.ManageNullDecimal(dr["acp_total_played_weighted"]),
                                    acp_total_won_weighted = ManejoNulos.ManageNullDecimal(dr["acp_total_won_weighted"]),
                                    acp_total_plays = ManejoNulos.ManageNullInteger(dr["acp_total_plays"]),
                                    acp_min_cash_in_reward = ManejoNulos.ManageNullDecimal(dr["acp_min_cash_in_reward"]),
                                    acp_redeemable_played = ManejoNulos.ManageNullDecimal(dr["acp_redeemable_played"]),
                                    acp_awarded_promotion_discounted = ManejoNulos.ManegeNullBool(dr["acp_awarded_promotion_discounted"]),
                                    acp_converted_amount = ManejoNulos.ManageNullDecimal(dr["acp_converted_amount"]),
                                    acp_auto_conversion = ManejoNulos.ManegeNullBool(dr["acp_auto_conversion"]),
                                    acp_lock_percentage = ManejoNulos.ManageNullDecimal(dr["acp_lock_percentage"]),
                                    acp_include_recharge = ManejoNulos.ManegeNullBool(dr["acp_include_recharge"]),
                                    acp_min_cash_in = ManejoNulos.ManageNullDecimal(dr["acp_min_cash_in"]),
                                    acp_min_spent = ManejoNulos.ManageNullDecimal(dr["acp_min_spent"]),
                                    acp_min_spent_reward = ManejoNulos.ManageNullDecimal(dr["acp_min_spent_reward"]),
                                    acp_num_tokens = ManejoNulos.ManageNullInteger(dr["acp_num_tokens"]),
                                    acp_num_used_tokens = ManejoNulos.ManageNullInteger(dr["acp_num_used_tokens"]),
                                    acp_token_reward = ManejoNulos.ManageNullDecimal(dr["acp_token_reward"]),
                                };
                                result.Add(item);
                            }
                        }
