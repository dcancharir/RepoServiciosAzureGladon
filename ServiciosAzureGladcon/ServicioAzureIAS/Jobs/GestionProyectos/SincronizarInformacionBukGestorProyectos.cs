...
namespace ServicioAzureIAS.Jobs.GestionProyectos {
    public class SincronizarInformacionBukGestorProyectos : IJob {
        ...
        public async Task Execute(IJobExecutionContext context) {
            ...
            //            funciones.logueo("E Actualizado:");
            //            funciones.logueo(empresa.ToString());
            //            await empresaDAL.ActualizarEmpresa(empresa);
            //        }
            //    } else {
            //        funciones.logueo("E insertado:");
            //        funciones.logueo(empresa.ToString());
            ...
            //        };
            //        //Area areaDyd = await areaDAL.ObtenerAreaPorIdBuk(empleado.IdAreaBuk);
            ...
            //#region usuarios
            //funciones.logueo("fin de area usuario:");
            ...
            //}
            //funciones.logueo("fin de usuario:");
            //#endregion
            ...
            foreach(var empresaGestor in empresasGestor) {
                ...
                if(empresaPro == null) {
                    ...
                    funciones.logueo($"Empresa Insertada: {empresaGestor}");
                } 
                if(empresaPro != null && empresaPro.isDifferentEmpresa(empresaGestor)) {
                    ...
                    funciones.logueo($"Empresa Actualizada: {empresaGestor}");
                }
            }
            //funciones.logueo("fin copiado de empresas a gestor pro:");
            #endregion empresas
            ...
            foreach(var areaGestor in areasGestor) {
                ...
                if(areaPro == null) {
                    ...
                    funciones.logueo($"Área Insertada: {areaGestor}");
                    ...
                    funciones.logueo($"Área Actualizada: {areaGestor}");
                }
            }
            #endregion Areas
            ...
            foreach(var empleadoGestor in empleadosGestor) {
                ...
                if(empleadoPro == null) {
                    ...
                    funciones.logueo($"Empleado Insertado: {empleadoGestor}");
                    ...
                    funciones.logueo($"Empleado Actualizado: {empleadoGestor}");
                }
            }
            #endregion empleados
            ...
            foreach(var usuarioProUpdate in usuariosPro) {
                ...
                if(usuario.isDifferentUsuario(usuarioActualizado)) {
                    ...
                    funciones.logueo("Actualizado:");
                    funciones.logueo(usuarioActualizado.ToString());

                }
            }
            // funciones.logueo("fin copiado usuarios a gestor pro:");
            funciones.logueo("fin del job:");
            #endregion Usuarios
