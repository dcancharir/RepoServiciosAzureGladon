...
namespace ServicioAzureIAS {
    public class ServicioController : ApiController {
        private readonly consolidado_deleteDAL consolidado_deleteDAL;
        private readonly consolidado_tmpDAL consolidado_tmpDAL;
        private readonly consolidadoDAL consolidadoDAL;
        private readonly detalle_maquinaDAL detalle_maquinaDAL;
        private readonly detalle_maquinas_auditDAL detalle_maquinas_auditDAL;
        private readonly maquinaDAL maquinaDAL;
        private readonly maquinas_auditDAL maquinas_auditDAL;
        private readonly salaDAL salaDAL;
        private readonly MinceturService minceturService;

        public ServicioController() {
            consolidado_deleteDAL = new consolidado_deleteDAL();
            consolidado_tmpDAL = new consolidado_tmpDAL();
            consolidadoDAL = new consolidadoDAL();
            detalle_maquinaDAL = new detalle_maquinaDAL();
            detalle_maquinas_auditDAL = new detalle_maquinas_auditDAL();
            maquinaDAL = new maquinaDAL();
            maquinas_auditDAL = new maquinas_auditDAL();
            salaDAL = new salaDAL();
        ...
        [HttpPost]
        public async Task<IHttpActionResult> ObtenerLudopatasMincetur([FromBody]dynamic obj) {
            string credencial = obj["credencial"];
            if(string.IsNullOrEmpty(credencial)) {
                return BadRequest("No se envío una credencial");
            }
            ResponseMinceturLudopata responseMincetur = await minceturService.ObtenerLudopataMincetur(credencial);
            //ResponseMinceturLudopata responseMincetur = minceturService.ObtenerLudopataMinceturLocal();
            return Ok(responseMincetur);
        }
